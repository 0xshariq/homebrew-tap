class PackageInstallerCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xshariq/homebrew-tap/releases/download/v1.0.0/package-installer-cli-1.1.0-darwin-arm64.tar.gz"
      sha256 "aa5b5f7977e68fe968cae36d9dea851d630e59ea817d22b9d7e211351483cb77"
    else
      url "https://github.com/0xshariq/homebrew-tap/releases/download/v1.0.0/package-installer-cli-1.1.0-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/0xshariq/homebrew-tap/releases/download/v1.0.0/package-installer-cli-1.1.0-linux-arm64.tar.gz"
      sha256 "0f43b309a2f96a059edaa795a32dc442c97e0bbb1c5d79b9f9ba23d910e2359a"
    else
      url "https://github.com/0xshariq/homebrew-tap/releases/download/v1.0.0/package-installer-cli-1.1.0-linux-amd64.tar.gz"
